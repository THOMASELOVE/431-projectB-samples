---
title: "431 Project B Sample Study 1"
...
2. For heaven's sake, DO NOT use my words included in this example report in your project. Rewrite everything to make it relevant to your situation. Do not repeat my instructions back to me. 
...
This document demonstrates a variety of things required in your Project B Study 1. We will demonstrate ideas using data from a 2015 class survey, gathered in three data files available in the Project B folder on the [431-data website](https://github.com/THOMASELOVE/431-data/tree/main/projectB/data). The files are called:
